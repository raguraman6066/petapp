...
//sec 3
  ...
  String? petAround = 'Not Applicable';
...
//section 11
                              ...
                              onSubmit: () async {
                                ...
                                if (formKey.currentState!.validate()) {
                                  if (_signcontroller.isEmpty) {
                                    ...
                                    exportedImage =
                                        await _signcontroller.toPngBytes();
                                    isLoading = true;
                                    this.setState(() {});

                                    AddPet.AddPetDetails(
                                      id: widget.id,
  ...
  SignatureController _signcontroller = SignatureController(
    penStrokeWidth: 2,
    penColor: Colors.red,
